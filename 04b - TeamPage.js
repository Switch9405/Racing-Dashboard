    ...
    const getTeamImage = (teamName) => {
      switch (normalize(teamName)) {
        case normalize("Apex Dynamics"):
          return `<img src="https://i.postimg.cc/xdYTCcQF/Apex-Dynamics-Panther-Dynamic.png" alt="Æpex Racing Car" width="500">`;
        case normalize("Pinecrest Motorsports"):
          return `<img src="https://i.postimg.cc/CKYL1z0r/Pinecrest-Motorsports-Panther-Dynamic.png" alt="Pinecrest Racing Car" width="500">`;
        case normalize("Whiteline Racing"):
          return `<img src="https://i.postimg.cc/9fVFMr2n/Whiteline-Racing-Panther-Dynamic.png" alt="Whiteline Racing Car" width="500">`;
        default:
          return "";
      }
    };
            ...
            ">
              ...
              <div class="team-name-lines">
                <div class="line-group">
                  ...
                  <div class="line bottom-line" style="background-color: ${teamColour2};"></div>
                </div>
...
function renderDriverStats(driverName, seasonStats, sprintStats, multiclassStats, featureStats, careerStats) {
  ...
  const createStatDivs = (titleOrStatsObj, maybeStatsObj) => {
    ...
    // ✅ Build trophy icons cleanly
    let trophyIcons = '';
    if (statsObj.TeamChampionships) {
      const count = parseInt(statsObj.TeamChampionships, 10) || 0;
      if (count > 0) {
        const trophyImg = 'https://i.postimg.cc/wByXJff4/Teams-Trophy.png';
        const trophies = Array.from({ length: count }, () =>
          `<img src="${trophyImg}" alt="Team Trophy" width="32" height="32">`
        ).join('');
        trophyIcons = `
    ...
    return `
      <div class="stat-block">
        ...
        ${trophyIcons} <!-- trophies appear here -->
      </div>
    `;
  };
