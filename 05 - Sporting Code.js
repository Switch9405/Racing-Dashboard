const RULES_DOC_URL = "https://docs.google.com/document/d/e/2PACX-1vQ6HAEXTRU-0_MxwH2Yzusb6laou0hRARfhrurj3ksPWR1Qj_VW9RE6MBvKqpQY86OtOED4YXTZNH_4/pub";
...
fetch(RULES_DOC_URL)
  ...
  .then(html => {
    ...
    if (title) title.classList.add("rc-title");
