...
const teamBlockHTML = `
  <div 
    ...
    style="
      background-image: url('https://i.postimg.cc/T3XbjVYx/Small-Team-Background-MASK.png');
  ...
  >
    ...
    <div class="team-image-row">
      <div class="line-group left-lines">
        <div class="line top-line" style="background-color: ${row[columnIndex.TEAM_COLOUR_1]};"></div>
        <div class="line bottom-line" style="background-color: ${row[columnIndex.TEAM_COLOUR_2]};"></div>
      </div>
      ...
      <div class="line-group right-lines">
        <div class="line top-line" style="background-color: ${row[columnIndex.TEAM_COLOUR_1]};"></div>
        <div class="line bottom-line" style="background-color: ${row[columnIndex.TEAM_COLOUR_2]};"></div>
      </div>
    </div>
